# Generated by Django 2.1.5 on 2020-08-31 20:06
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Enterer une forme de produit (exemple: Liquide ...)', max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='Language',
        ...
        migrations.AddField(
            model_name='book',
            name='forme',
            field=models.ManyToManyField(help_text='Selectionner une forme pour ce produit.', to='catalog.Forme'),
        ),
        migrations.AddField(
            model_name='book',
            name='language',
